...
public class AuthSSLProtocolSocketFactory extends SSLSocketFactory {
    ...
    public AuthSSLProtocolSocketFactory(
        ...
        final URL truststoreUrl, final String truststorePassword) throws KeyManagementException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, CertificateException, IOException
    {
        super(createKeyStore(keystoreUrl, keystorePassword));
