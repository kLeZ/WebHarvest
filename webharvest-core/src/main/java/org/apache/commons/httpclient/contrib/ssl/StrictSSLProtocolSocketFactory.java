 ...
 * </p>
 */
public class StrictSSLProtocolSocketFactory extends SSLSocketFactory {
     ...
     * @throws NoSuchAlgorithmException 
     */
    public StrictSSLProtocolSocketFactory() throws NoSuchAlgorithmException {
        super(SSLContext.getInstance("SSL"));
    }
    ...
    public Socket createSocket(String host, int port, 
    	...
    	SSLSocket sslSocket = (SSLSocket) sf.createSocket(new Socket(host, port), clientHost.toString(), clientPort, true);
